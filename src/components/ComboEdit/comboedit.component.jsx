    ...
    <div className="combo-edit">
      ...
      <div className="combo-edit_infor">
        <form className="frm-combo-edit">
          <label className="combo-edit_label">Mã combo: 
            <input type="text" disabled/>
          </label>
          <label className="combo-edit_label">Tên combo: <span className="proirity">*</span>
            <input type="text"/>
          </label>
      ...
      <div className="combo-right">
          <h3>Chọn món ăn</h3>
          <label className="combo-edit_label">Loại: <span className="proirity">*</span>
            <select>
          ...
          <label className="combo-edit_label">Danh sách món ăn
              <table>
                  <tr>
                    <td>Gà nướng</td>
                    <td>Số lượng: <input type="text" className="input-number" /></td>
          ...
          <label className="combo-edit_label">Các món đã chọn: 
            <Select
